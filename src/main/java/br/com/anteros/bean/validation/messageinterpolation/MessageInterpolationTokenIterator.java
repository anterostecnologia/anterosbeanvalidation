 ...
 */
public class MessageInterpolationTokenIterator {
	private final List<MessageInterpolationToken> tokenList;
	...
	public MessageInterpolationTokenIterator(List<MessageInterpolationToken> tokens) {
		this.tokenList = new ArrayList<MessageInterpolationToken>( tokens );
	}
	...
	public String getInterpolatedMessage() {
		...
		for ( MessageInterpolationToken token : tokenList ) {
