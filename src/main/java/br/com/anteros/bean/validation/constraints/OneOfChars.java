...
import br.com.anteros.bean.validation.constraints.validators.OneOfCharsValidator;
...
public @interface OneOfChars {
    String message() default "{br.com.anteros.bean.validation.constraints.ONE_OF_CHARS.message}";
