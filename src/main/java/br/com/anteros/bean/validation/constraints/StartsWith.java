...
import br.com.anteros.bean.validation.constraints.validators.StartsWithValidator;
...
public @interface   StartsWith {
    String message() default "{br.com.anteros.bean.validation.constraints.STARTS_WITH.message}";
