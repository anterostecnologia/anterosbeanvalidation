...
import br.com.anteros.bean.validation.constraints.validators.TituloEleitoralValidator;
...
public @interface TituloEleitoral {
	String message() default "{br.com.anteros.bean.validation.constraints.TituloEleitoral.message}";
