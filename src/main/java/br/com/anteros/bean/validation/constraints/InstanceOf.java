...
import br.com.anteros.bean.validation.constraints.validators.InstanceOfValidator;
...
public @interface InstanceOf {
    String message() default "{br.com.anteros.bean.validation.constraints.INSTANCEOF.message}";
    Class<?>[] value();
